...
New-AzureRAmResourceGroup -Name $resourcegroupname -Location $location 
...
Swap-AzureRmWebAppSlot -Name $webappname -ResourceGroupName $resourcegroupname `
    -SourceSlotName "test" -DestinationSlotName production